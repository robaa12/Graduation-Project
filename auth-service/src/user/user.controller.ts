...
export class UserController {
  ...
  @ApiOperation({summary: 'Login User' , requestBody: {content: {'application/json': {schema: {type: 'object'}, example:{
    "email":"jhon@doe.com",
    "password":"Password"
  } }}}})
  @Post('login')
  ...
  @ApiOperation({summary: 'Verify Email' , requestBody: {content: {'application/json': {schema: {type: 'object'}, example:{
    "email":"jhon@doe.com",
    "otp":"123456"
  }}} }})
  @Post('verify-email')
